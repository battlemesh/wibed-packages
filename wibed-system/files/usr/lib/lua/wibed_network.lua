...
local wibed_network = wibed_network or {}
...
local function get_primary_device()
  ...
  local rdevices = wibed_wireless.get_wireless_radio_devices()
...
local function get_vlan_ethernet_devices()
  ...
  for k, v in pairs(vdevices) do
    local files = wibed_io.ls(PATH_SYS_CLASS_NET .. v)
...
wibed_network.call_ubus_network_device_status = call_ubus_network_device_status
wibed_network.get_all_devices = get_all_devices
wibed_network.get_primary_device = get_primary_device
wibed_network.get_device_mac = get_device_mac
wibed_network.get_ethernet_devices = get_ethernet_devices
wibed_network.get_ethernet_switch_devices = get_ethernet_switch_devices
wibed_network.get_etherswitch_devices = get_etherswitch_devices
wibed_network.get_etherswitch_swconfig_devices = get_etherswitch_swconfig_devices
wibed_network.get_switch_devices = get_switch_devices
wibed_network.get_vlan_devices = get_vlan_devices
wibed_network.get_vlan_ethernet_devices = get_vlan_ethernet_devices
wibed_network.is_ethernet_device = is_ethernet_device
wibed_network.is_ethernet_switched_device = is_ethernet_switched_device
wibed_network.is_network_device = is_network_device
wibed_network.is_valid_mac = is_valid_mac

return wibed_network
